...
exports.LicensingIntegrationTest = void 0;
...
class LicensingIntegrationTest {
    ...
    async runLicenseManagerTests() {
        ...
        await this.runTest(suite, 'License Manager Initialization', async () => {
            const licenseManager = LicenseManager_1.LicenseManager.getInstance(this.context);
            if (!licenseManager) {
    ...
    async runFeatureGateTests() {
        ...
        await this.runTest(suite, 'Feature Gate Initialization', async () => {
            const featureGate = FeatureGate_1.FeatureGate.getInstance(this.context);
     ...
     */
    async runConfigurationManagerTests() {
        const suite = {
        ...
        await this.runTest(suite, 'Configuration Manager Initialization', async () => {
            const configManager = ConfigurationManager_1.ConfigurationManager.getInstance(this.context);
    ...
    async runSystemIntegrationTests() {
        ...
        await this.runTest(suite, 'Licensing System Initialization', async () => {
            const licensingSystem = await index_1.LicensingSystem.initialize(this.context);
...
exports.LicensingIntegrationTest = LicensingIntegrationTest;
//# sourceMappingURL=LicensingIntegrationTest.js.map